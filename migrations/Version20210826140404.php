...
final class Version20210826140404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pilots_public_ids (public_id VARCHAR(100) NOT NULL, pilot SMALLINT UNSIGNED NOT NULL, INDEX IDX_2905B79F8D1E5F52 (pilot), PRIMARY KEY(pilot, public_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE pilots ADD CONSTRAINT FK_9EE6E18C62F1E114 FOREIGN KEY (birth_city) REFERENCES cities (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE pilots_public_ids ADD CONSTRAINT FK_2905B79F8D1E5F52 FOREIGN KEY (pilot) REFERENCES pilots (id) ON DELETE CASCADE');
    }
